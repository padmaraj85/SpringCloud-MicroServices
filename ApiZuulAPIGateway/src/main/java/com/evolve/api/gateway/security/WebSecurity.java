package com.evolve.api.gateway.security;
...
public class WebSecurity extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
    		...
    		// Disable security for few apps and enable security for others as eblow.
    	http.csrf().disable(); 
    	...
    	// add authentication filter to restrict access to rest of the application
